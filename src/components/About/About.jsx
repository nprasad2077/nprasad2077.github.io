      ...
      <div className="about p-2">
        <Card>
          ...
          <p className="font-normal text-gray-700 dark:text-gray-400 mb-10">
            ...
            variety of technologies such as React, Node.js, and Django, and am
            always looking to stay up-to-date with the latest advancements in
            the industry. My experience in Python and JavaScript also allows me
            to work on a range of projects, from web applications to data
            analysis and automation tasks. I am a strong collaborator and able
            to work in a fast-paced environment, always focused on delivering
