  ...
  return (
    <div class="flex flex-row flex-wrap" id="project">
      <div className="child-1 mt-2">
        <Card horizontal={true} imgSrc="/assets/bob/bob.png">
      ...
      >
        <div className="child-2">
          <Card horizontal={false} imgSrc="assets\shot\store.png">
            ...
            <p className="font-normal text-gray-700 dark:text-gray-400">
              Webstore is an E-commerce front-end site that uses the Fake Store
              API.
            </p>
            <p className="font-normal text-gray-700 dark:text-gray-400">
      ...
      <a href="https://front-end-travel-app.vercel.app/" className="travel">
        <div className="travel" id="project-target">
          <Card horizontal={false} imgSrc="\assets\shot\travel.png">
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Travel Base
            </h5>
            <p className="font-normal text-gray-700 dark:text-gray-400">
      ...
      <a href="https://project-2-teal.vercel.app/" className="nutri">
        <div className="nutri">
      ...
      >
        <div className="child-4">
          <Card horizontal={false} imgSrc="\assets\shot\pokemon.png">
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Pokemon Match!
            </h5>
            <p className="font-normal text-gray-700 dark:text-gray-400">
